...
const experiences: Experience[] = [
  {
    ...
    summary:
      "Sole backend developer for the automation module of a live B2B SaaS platform, and a lead backend contributor on an enterprise client analytics platform — owning RESTful APIs, relational databases, background tasks, and cloud deployment pipelines end-to-end.",
    projects: [
      {
        ...
        tech: ["Flask", "PostgreSQL", "Supabase", "Redis", "Celery", "RabbitMQ", "Twilio API", "Meta WhatsApp API", "JWT", "Wasabi S3", "Docker", "Nginx"],
        bullets: [
          "Sole backend developer for InaiWazhi's automation module, owning architecture, feature development, and production maintenance end-to-end.",
          ...
          "Designed multi-branch WhatsApp automation flows with condition-based node routing, retry logic for invalid user inputs, and support for both template-triggered and keyword-triggered flows.",
          "Built an authentication-verification middleware layer on top of Supabase-managed authentication to validate tokens and scope backend API access to the authenticated user.",
          "Implemented Redis caching for the contact module to improve data-access performance for high-traffic messaging workflows.",
          ...
          "Utilized Pandas for CSV/Excel data validation and structured data import into production databases, and implemented Celery and RabbitMQ for asynchronous and scheduled background task processing.",
          "Implemented idempotency-key logic and rate-limited, log-driven message sending to improve delivery reliability for automated campaigns.",
          ...
          "Added subaccount-based multi-tenant isolation to keep data and messaging correctly scoped across client accounts.",
          "Debugged and resolved production issues — including a WhatsApp media-delivery failure caused by videos missing an audio track, fixed by adding a silent AAC audio stream to meet Twilio/WhatsApp media requirements — improving application reliability and backend performance.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Tested and validated financial-reporting endpoints — including General Ledger, Customer Ledger, Vendor Ledger, and financial-document retrieval APIs — in Postman ahead of frontend integration.",
          "Deployed the platform as a Dockerized Django/Gunicorn application behind an Nginx reverse proxy, with GitHub Actions CI/CD and a self-hosted PostgreSQL database.",
    ...
    projects: [
      {
        ...
        tech: ["Python", "ArcFace", "InsightFace", "OpenCV", "MySQL", "YOLOv5", "YOLOv8", "n8n", "Mistral AI"],
        bullets: [
          "Developed a Python-based automated attendance system using ArcFace, OpenCV, insightface, and onnxruntime, writing clean, modular Python code for optimized face detection, recognition, and attendance logging.",
          ...
          "Worked with YOLOv5 and YOLOv8 for object detection, including dataset annotation with LabelImg, model training, and model evaluation.",
